  ...
  return abc?(
    <>
      ...
      <main>
        ...
        <div className="dice-container">{"$Value of Token left in this session : "}{totalMint}</div>
        ...
        {tenzies&&<img src={abc} height="50px"/>}
        <button className="roll-dice" onClick={rollDice}>
          {tenzies ? "New Game" : "Roll"}
        </button>
        {totalMint>0?<a href={"https://www.youtube.com/"} target="_blank" onClick={(e) => watchVideo()}>Watch Video</a>:null}
        <div className="stats">
          <div>
            Rolls:
            <br />
          ...
          {bestRoll ? (
            <div>
              ...
              <br />
              {bestRoll}
              {/* <button  onClick={()=>{setBestRoll(0);localStorage.setItem("bestRoll", "0");window.location.reload()}}>Reset Best</button> */}
            </div>
          ) : (
            ""
          )}
